    ...
    <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-9 h-9 rounded-full flex items-center justify-center text-white text-xs font-bold ${
                          admin.ruolo === "superadmin" ? "bg-accent" : "bg-primary"
                        }`}
                      >
                  ...
                  <td className="px-5 py-4">
                    <div className="flex items-center justify-end gap-1">
                      ...
                      <button
                        ...
                        className="p-2 rounded-lg text-foreground/40 hover:text-accent hover:bg-accent/10 transition-colors disabled:opacity-50"
      ...
      {pendingRequests.length > 0 && (
        <div className="bg-surface rounded-xl border border-border overflow-hidden">
          <div className="px-5 py-4 bg-accent/10 border-b border-accent/20 flex items-center gap-2">
