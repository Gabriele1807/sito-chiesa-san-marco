...
export async function getUserRoleServer(): Promise<
  "guest" | "credente" | "madre" | "padre" | "diacono" | "ospite_chiesa" | "admin" | "superadmin"
> {
  try {
    ...
    const validRoles: SystemRole[] = ["guest", "credente", "madre", "padre", "diacono", "ospite_chiesa", "admin", "superadmin"];
